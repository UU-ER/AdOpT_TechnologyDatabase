...
class Dac_sievert(Component):
    ...
    def __init__(self, dac_technology):
        super().__init__()
        ...
        dac_input_path = Path(__file__).parent / Path(
            "./data/dac/inputs_DACS_single.xlsx"
        )
    ...
    def calculate_cost(self, currency, year, discount_rate, cumulative_capacity=0):
        """
    ...
    def _calculate_startup_costs(self, cumulative_capacity):
        ...
        gas_price = self.gas_prices.loc["NG", self.financial_year_out]
